...
export function CreateEventPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Logic for submitting to Firebase / API
    ...
    <div className="max-w-3xl mx-auto space-y-8 py-4 sm:py-8">
      ...
      <div className="text-center p-6 sm:p-8 rounded-[24px] bg-slate-50 border border-slate-100">
        ...
        <p className="text-[13px] text-slate-600 font-medium max-w-lg mx-auto leading-relaxed">
          The best events have clear descriptions and beautiful cover images. Events with photos get <span className="text-primary font-bold">45% more engagement</span> from the Junta community.
        </p>
      </div>
    </div>
  );
